// ============================================
// ELITE RENTALS PORTAL - COMPLETE FUNCTIONALITY
// ============================================

// Dynamic year
document.getElementById('year').textContent = new Date().getFullYear();

// ========== HAMBURGER MENU TOGGLE (DEBUGGED) ==========
...
function closeMenu() {
  ...
  if (navMenu) {
    ...
    console.log('navMenu active class removed');
  }
  if (hamburger) {
...
function openMenu() {
  ...
  if (navMenu) {
    ...
    console.log('navMenu active class added');
...
function renderPagination(filteredProperties) {
...
function renderProperties(properties) {
  ...
  if (resultCountSpan) resultCountSpan.textContent = properties.length;
...
function applyFilters() {
  return allProperties.filter(prop => {
    const matchNeighborhood = currentFilters.neighborhood === 'all' || prop.estate === currentFilters.neighborhood;
    const matchType = currentFilters.type === 'all' || prop.type === currentFilters.type;
    const matchPrice = prop.price <= currentFilters.maxPrice;
    return matchNeighborhood && matchType && matchPrice;
  });
}
